    ...
    <div className="w-full lg:flex lg:flex-row items-center">
      <div className="levels">
        <div className="mt-20 ml-6 flex flex-col text-white text-md w-72 shadow-lg bopacity-90 rounded-md">
          <h1 className="font-bold bg-black m-1 text-3xl rounded-md opacity-70">
            Easy ⭐
          </h1>
      ...
      <div className="levels">
        <div className="mt-20 ml-6 flex flex-col text-white text-md w-72 shadow-lg bopacity-90 rounded-md">
          ...
          <h5 className="font-bold bg-black m-1 rounded-md opacity-70">
            ...
            buscados sin tener conocimiento de sus rasgos físicos. No traduciremos los
            expedientes por tí. Demuéstranos tu talento!
          </h5>
          <div className="m-1">
            <Link to="/game/level2">
              <Button color={"warning"}>Start Hunting</Button>
